To use this install any CSS injector extention/plugin or use the custom CSS option on the Youtube Enhancer plugin/extension and configure it with the following CSS.
```
